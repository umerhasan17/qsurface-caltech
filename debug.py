...
from qsurface.main import initialize, run
code, decoder = initialize((6,6), "planar", "ufbfs", enabled_errors=["pauli"], plotting=True, initial_states=(0,0))
result = run(code, decoder, error_rates = {"p_bitflip": 0.1}, decode_initial=False)
print(result)